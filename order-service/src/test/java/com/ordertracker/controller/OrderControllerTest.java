...
class OrderControllerTest {
    ...
    void createOrder_WithEmptyItems_ShouldReturn400() throws Exception {
        OrderRequest request = OrderRequest.builder()
                ...
                .items(List.of())   // Empty list — violates @NotEmpty
                .build();
    ...
    void getOrder_WithValidOrderNumber_ShouldReturn200() throws Exception {
        when(orderService.getOrderByNumber(any(), any())).thenReturn(sampleOrderResponse);
    ...
    @Test
    @DisplayName("GET /api/v1/orders/{orderNumber} - Should return 401 when unauthenticated")
    void getOrder_WhenUnauthenticated_ShouldReturn401() throws Exception {
        mockMvc.perform(get("/api/v1/orders/ORD-ABC12345"))
